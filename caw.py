...
def get_content(page,lastId):
 ...
 return html
# https://video.coral.qq.com/varticle//comment/v2?callback=_varticlecommentv2&orinum=10&oriorder=o&pageflag=1&cursor=0&scorecursor=0&orirepnum=2&reporder=o&reppageflag=1&source=132&_=
#从源码中获取评论的数据
